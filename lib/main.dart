...
import 'package:pigeon_demo1/pigeon.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  _getMessages()async{
    final retrived = await MessagesApi().getMessages("eric@none.com");
    setState(() {
      messages = retrived;
    });
  }
      ...
      body: Padding(
        ...
        child: DataTable(
          columns: [
            ...
            DataColumn(label:Center(child: Text("body")),),
          ...
          rows:messages.map(
              ...
              DataRow(cells:[
                ...
                DataCell(Center(child: Text(e?.body??'')),),
